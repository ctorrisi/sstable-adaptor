 ...
 */
public final class FileChannelProxy extends ChannelProxy
{
    ...
    public FileChannelProxy(String path)
    {
        this (new File(path));
    }

    public FileChannelProxy(File file)
    {
        this(file.getPath(), openChannel(file));
    }

    public FileChannelProxy(String filePath, FileChannel channel)
    {
    ...
    public FileChannelProxy(FileChannelProxy copy)
    {
        super(copy);
    ...
    public FileChannelProxy sharedCopy()
    {
        return new FileChannelProxy(this);
    }
