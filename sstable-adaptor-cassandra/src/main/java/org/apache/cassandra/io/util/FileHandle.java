...
public class FileHandle extends SharedCloseableImpl
{
    ...
    public static class Builder implements AutoCloseable
    {
        ...
        /**
         * Use this to compute buffer size
         * @param  optimizationStrategy DiskOptimizationStrategy to use for computing buffer size
         * @return this object
         */
        public Builder withOptimizationStrategy(DiskOptimizationStrategy optimizationStrategy)
        {
        ...
        /**
         * Use this to compute buffer size
         * @param  indexSummarySize int to use for computing buffer size
         * @return this object
         */
        public Builder withIndexSummarySize(int indexSummarySize)
        {
            this.indexSummarySize = indexSummarySize;
            return this;
        }
